...
> [!NOTE]
> You are inside the **@elcoosp-configs/cspell** workspace member package, not the repository entry point
...
```sh
pnpm add @elcoosp-configs/cspell
```
```sh
npm add @elcoosp-configs/cspell
```
```sh
yarn add @elcoosp-configs/cspell
```
```sh
deno add npm:@elcoosp-configs/cspell
```
```sh
bun add @elcoosp-configs/cspell
```
...
[npm-version-shield]: https://img.shields.io/npm/v/@elcoosp-configs/cspell.svg?style=for-the-badge&logo=npm&logoColor=f5f5f5
