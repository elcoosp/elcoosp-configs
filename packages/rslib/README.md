...
```
```sh
deno add npm:@elcoosp-configs/rslib
```
```sh
bun add @elcoosp-configs/rslib
```
...
[npm-version-shield]: https://img.shields.io/npm/v/@elcoosp-configs/rslib.svg?style=for-the-badge&logo=npm&logoColor=f5f5f5
