...
```
```sh
bun add @elcoosp-configs/docusaurus
```
...
[npm-version-shield]: https://img.shields.io/npm/v/@elcoosp-configs/docusaurus.svg?style=for-the-badge&logo=npm&logoColor=f5f5f5
